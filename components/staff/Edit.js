...
const Edit = ({ message, id, data  }) => {
  ...
  const showEditForm = () => {
        ...
        setShow(true);
        try {
            const { name, mobile, adderss } = data;
            setName(name);
            setMobile(mobile);
            setAdderss(adderss);
        } catch (err) {
    ...
    const updateHandler = async (e) => {
        ...
        try {
            ...
            const msg = await updateDataToIndexDB('staff', id, newObject);
            message(msg);
        } catch (error) {
                        ...
                        <div className="px-6 pb-6 text-black">
                            <form onSubmit={updateHandler} >
                                <div className="grid grid-cols-1 gap-4 my-4">
                                    ...
                                    <TextEn Title="Adderss" Id="adderss" Change={e => setAdderss(e.target.value)} Value={adderss} Chr={150} />                                
                                </div>
